...
他のコマンドはuCNCの [Github](https://github.com/Paciente8159/uCNC/wiki/) もしくは  
GRBLの [Github](https://github.com/grbl/grbl)を参照してください。  
Gコードは機械加工でとても一般的な通信仕様です。他にもネットで調べればGコードについての情報がたくさんあります。ググって調べて、多少理解してから利用してください。  
（テレビ番組の予約ルールもGコードと読んでいますので、間違えないように）  
...
Rod: M12 P1.75  
ActualSPM:$`\frac{200 \times 20.909090}{1.75} = 2389.61 \approx 2400 [step/mm] `$

| No-load speed | Load speed | 推力 (Thrust) | 拉力 (Pull) | 自锁力 (Self-locking force) |
| :--- | :--- | :--- | :--- | :--- |
| 0.5mm/s (30mm/min)| 0.3mm/s | 900N | 800N | 2000N |
| 1mm/s | 0.8mm/s | 750N | 600N | 1000N |
| 1.5mm/s | 1.2mm/s | 600N | 550N | 700N |
| 2mm/s (120mm/min)| 1.6mm/s | 450N | 400N | 500N |
| 2.5mm/s | 2mm/s | 350N | 300N | 400N |
| 3mm/s | 2.5mm/s | 300N | 250N | 400N |
| 4mm/s (240mm/min)| 3.5mm/s | 200N | 150N | 300N |
...
NEMA17保持トルク（参考 17HE24-2104S）: 60[Ncm]  
ギア効率: 95[%] * 3段 = 85[%]  
ギア比: 21  
最終段トルク: 0.6[Nm]*21*0.85=10[Nm]  
M12締付トルク(Kt=0.2): 39[Nm] (安全率4倍)  
トルク係数Kt: 0.2  
軸力: 10[Nm]/(12*0.2)=4167[N]

理論上は4000[N]まで耐えられるが、安全率2倍取って、2000[N]の保持力としているのだろう。  
回転トルクは回転速度次第だが、保持トルクの2割（高速）から5割（低速）程度なのが定説。  
低速回転トルク 1000[N], 高速回転トルク 400[N] とするとおおよそ計算と合う。  
安全率撤去＋マイクロステッピングと考えると、  
低速時に 2000~3000[N]程度でていても不思議ではない。  
...
$27=1; After Home, Set Back Little Bit [mm]
...
$110=40; X Max Speed[mm/min]
$111=40; Y Max Speed[mm/min]
$112=40; Z Max Speed[mm/min]
$113=40; A Max Speed[mm/min]
$114=40; B Max Speed[mm/min]
